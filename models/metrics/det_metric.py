...
from .textdet_eval import DetectionIoUEvaluator
...
class DetMetric(object):
    ...
    def __call__(self, preds, batch, **kwargs):
       ...
       '''
        ...
        for img, pred, gt_polyons, ignore_tags in zip(img_batch, preds,
                                                      gt_polyons_batch,
                                                      ignore_tags_batch):
            # prepare gt
            gt_info_list = [{
            ...
            result = self.evaluator.evaluate_image(img, gt_info_list,
                                                   det_info_list)
