...
from .model_base import _default_tfmer_cfg
...
class BCNLanguage(Model):
    def __init__(self, configArch):
        config = configArch['Models']
        ...
        self.max_length = config['max_text_length'] + 1  # additional stop token
        self.debug = config.get('global_debug', False)
    ...
    def forward(self, tokens, lengths):
        ...
        Args:
            ...
            lengths: (N,)
        """
        if self.detach: tokens = tokens.detach()  # BGF
