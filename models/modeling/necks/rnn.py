...
from ..backbones.rec_svtrnet import Block, ConvBNLayer, trunc_normal_, zeros_, ones_
...
if __name__=="__main__":
    model = SequenceEncoder(512, 'svtr', dims=64,
        depth=2,
        hidden_dims=120,
        use_guide=True)
    ...
    arr = torch.rand((1, 512, 1, 80))

    summary(model, input_size=(1, 512, 1, 80), device="cpu")
    out = model(arr)
    print(out.size())