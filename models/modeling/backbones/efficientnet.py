...
class MBConvConfig(_MBConvConfig):
    ...
    def __init__(
        ...
        if block is None:
            block = MBConv
        super().__init__(expand_ratio, kernel, stride, input_channels,
                         out_channels, num_layers, block)
...
class MBConv(nn.Module):
    ...
    def __init__(
        ...
        # project
        layers.append(
            Conv2dNormActivation(expanded_channels,
                                 cnf.out_channels,
                                 kernel_size=1,
                                 norm_layer=norm_layer,
...
class EfficientNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.out_channels = [64, 96, 224, 1280]
...
if __name__ == "__main__":
    ...
    inverted_residual_setting, last_channel = _efficientnet_conf(
        "efficientnet_v2_l")
    model = EfficientNet(0.4,
                         inverted_residual_setting,
                         last_channel=last_channel).cuda()
    weight = torch.load(
        './pretrained_weights/efficientnet_v2_pretrained.ptparams')
